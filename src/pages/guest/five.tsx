        ...
        <div className='p-4 w-full max-w-2xl'>
          <div className='relative flex flex-col justify-center items-center rounded-lg min-h-[100vh] overflow-y-auto custom-scrollbar'>
            ...
            <form
              ...
              className='p-4 md:p-5 shadow bg-teal-50 w-full max-w-lg'
            >
              ...
              <div className='flex justify-between mt-10'>
                <button
                  ...
                  type='submit'
                  className='text-teal-700 bg-gray-50 hover:bg-teal-500 hover:text-gray-50 focus:ring-4 focus:outline-none focus:ring-teal-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center border border-teal-400'
                >
                  Submit
                </button>
