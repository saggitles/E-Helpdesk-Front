          ...
          {users.map((user, index) => (
            ...
            >
              ...
              <div className='grid grid-cols-2 gap-4 text-sm text-gray-600'>
                <p>
                  <strong>F-Code:</strong> {user.fCode}
                </p>
                <p>
                  <strong>Badge/Pin:</strong> {user.badgePin}
                </p>
                <p>
                  <strong>Weigand:</strong> {user.weigand}
                </p>
                <p>
                  <strong>M Code Access:</strong> {user.mCodeAccess}
                </p>
                <p>
