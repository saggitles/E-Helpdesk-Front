    ...
    const fetchData = async () => {
      try {
        ...
        const response = await axios.post<string>(
          `${process.env.NEXT_PUBLIC_API_URL}/api/iotdevices`,
          { Filter: 'none' },
          config
        );
  ...
  return (
    <div>
      <div className='container mx-auto'>
        <h1 className='text-blue-950 font-lato text-3xl mb-8 mt-8 font-bold'>
          Device List
        </h1>
        ...
        >
          ...
          <button
            ...
            className='text-white font-bold py-2 px-10 rounded-lg mb-4 mt-4 mr-4'
            style={{ backgroundColor: '#30bcb4' }}
          >
            Create New
          </button>
        </div>
        ...
        <div className='overflow-x-auto font-lato'>
          <table className='table-auto border-collapse w-full'>
            <thead>
              <tr>
                <th className='px-12 py-2 text-lg text-center'>
                  Device ID
                </th>
                <th className='px-12 py-2 text-lg text-center'>
                  Connection State
            ...
            <tbody>
              {devices.map((device: Device, index: number) => (
                <tr
                  key={index}
                  className='hover:bg-[#b0c434] hover:text-white cursor-pointer'
                >
                  ...
                  <td className='px-12 py-2 text-center'>
                    {device.properties
                      ? device.properties.lastUpdated
                      : ''}
                  </td>
                  <td className='px-12 py-2 text-center'>
                    {device.properties ? device.properties.version : ''}
                  </td>
                  <td className='px-12 py-2 text-center'>
                    {device.vehicleDesignation}
                  </td>
                </tr>
              ))}
            </tbody>
